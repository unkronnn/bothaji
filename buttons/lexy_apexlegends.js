...
module.exports = {
    customId: 'lexy_apexlegends',
    async execute(interaction) {
        const embed = new EmbedBuilder()
            .setTitle('👑 Lexy : Apex Legends')
            .setDescription(`
### 🧾**Pricing**
**1 DAY**   — IDR 144.500 / $8.50
**7 DAY**   — IDR 411.000 / $24.00
**30 DAY**  — IDR 935.500 / $56.00

A premium product for the game Apex Legend from Lexy group.
...
• Players who want comprehensive features
...
**Premium external cheat with professional features!**`)
            .addFields(
                ...
                {
                    name: '`📞` PURCHASE',
                    value: 'Contact our staff to get your Lexy Apex Legends cheat with premium features.'
                },
                {
            ...
            .setFooter({
                text: 'Lexy Apex Legends • Premium External Technology',
