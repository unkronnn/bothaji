...
module.exports = {
    customId: 'lexy_marvelrivals',
    async execute(interaction) {
        const embed = new EmbedBuilder()
            .setTitle('⭐ Lexy : Marvel Rivals - Premium External Cheat')
            .setDescription(
                `**Premium external cheat for Marvel Rivals from Lexy group.**\n\n` +
                `High-quality external cheat with built-in spoofer and comprehensive multi-client support.`
            )
            .addFields(
                {
                    name: '`💰` PRICING',
                    value: '**1 Day** - IDR 120.500 / $7.00\n**7 Days** - IDR 411.000 / $24.00\n**30 Days** - IDR 828.500 / $49.00'
                },
                {
                    name: '`💻` SYSTEM REQUIREMENTS',
                    value: '**OS:** Windows 10/11 (all builds)\n**CPU:** Intel & AMD\n**GPU:** Nvidia & AMD\n**Disk:** GPT & MBR\n**BIOS:** UEFI & Legacy\n**Type:** External Software\n**Client:** Official, Steam & Epic Games\n**Spoofer:** Built-in'
                },
                {
            ...
            .setFooter({
                text: 'Lexy Marvel Rivals • External • Built-in Spoofer • Multi-Client Support',
