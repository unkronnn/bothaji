...
• **Complete Categories:** Other, Ammo, Weapon, Armor, Money, Self, Booster, Gas Mask, Killstreak, Tactical, Grenades, Usable, Modification, Contract, Perk, Container, Market Station, Exchanger
...
**Ultimate hybrid cheat for Call of Duty domination!**`)
            .addFields(
                ...
                {
                    name: '`📞` PURCHASE',
                    value: 'Contact our staff to get your Fecurity COD premium cheat.'
                }
            )
            .setColor('#FF4500')
            ...
            .setFooter({
                text: 'Fecurity COD • Hybrid • AIO Bundle • Professional Grade',
