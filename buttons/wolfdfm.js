...
module.exports = {
    customId: 'wolfdfm', // Ganti dengan customId yang sesuai
    async execute(interaction) {
        const embed = new EmbedBuilder()
            .setTitle(`\`💳\` WOLF Delta Force (iOS)`) // Ganti dengan judul
            .setDescription(`
### 🧾**Pricelist**
* 1 Day  — IDR 50.000 / $3
* 7 Day  — IDR 150.000 / $10
* 30 Day  — IDR 280.000 / $18

### 📝**Feature:**
* ESP | AIMBOT
* ESP ITEM | LOOTING BOX
* Hide ESP Recording / Streaming
──────────────────`)
            .addFields(
                { 
                    name: '\`⚠️\` ATTENTION', 
