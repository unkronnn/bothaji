...
module.exports = {
    customId: 'xeindfm', // Ganti dengan customId yang sesuai
    async execute(interaction) {
        const embed = new EmbedBuilder()
            .setTitle(`\`💳\` XEIN Delta Force (Android)`) // Ganti dengan judul
            .setDescription(`
### 🧾**Pricelist**
* 1 Day  — IDR 25.000 / $3
* 3 Day  — IDR 50.000 / $3
* 7 Day  — IDR 120.000 / $3
* 14 Day  — IDR 200.000 / $10
* 30 Day  — IDR 280.000 / $18

### 📝**Feature:**
* ESP | Item RED / YELLOW
* AIMBOT 1.1 | Aim touch (Root)
* Auto Prediction | Recoil Compensation
* Bypass mobilador
