...
module.exports = {
    customId: 'pussycat_deadside',
    async execute(interaction) {
        const embed = new EmbedBuilder()
            .setTitle('🐱 PussyCat : Deadside - External Budget Cheat')
            .setDescription(`
### 🧾**Pricing**
...
A premium product for the game Deadside from PussyCat group.
...
✅ **Affordable Quality** - Cost-effective solution

### 🎮**Perfect For:**
• Budget-conscious Deadside players
• New players seeking basic advantages
• Casual wasteland explorers
...
### 🧟**Deadside Features:**
• **Survival Mechanics** - Health, hunger, thirst management
• **Resource Scavenging** - Loot collection system
• **Base Building** - Construction and defense
• **PvP Encounters** - Player vs player combat
• **Environmental Hazards** - Radiation and weather
...
---
**Budget-friendly external cheat for Deadside with essential features and maximum security!**`)
            .addFields(
                {
                ...
                {
                    name: '`📞` PURCHASE',
                    value: 'Contact our staff to get your PussyCat Deadside premium cheat.'
                }
            )
            .setColor('#FFB6C1')
            ...
            .setFooter({
                text: 'PussyCat Deadside • External • Budget-Friendly • Essential Features',
