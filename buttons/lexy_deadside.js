...
module.exports = {
    customId: 'lexy_deadside',
    async execute(interaction) {
        const embed = new EmbedBuilder()
            .setTitle('⭐ Lexy : Deadside - External Premium Spoofer Cheat')
            .setDescription(`
### 🧾**Pricing**
**1 DAY**   — IDR 140.500 / $8.00
**7 DAY**   — IDR 671.250 / $40.00
**30 DAY**  — IDR 1.303.000 / $78.00

A premium product for the game Deadside from Lexy group.
...
### 🎮**Perfect For:**
• Premium Deadside players
• Users wanting maximum protection
• Streamers requiring safety
• Players who prefer external stability
• Those seeking comprehensive features
• Users needing premium quality
• Players wanting reliable service

### 🧟**Deadside Features:**
• **Looter Shooter Mechanics** - Scavenge and survive gameplay
• **Open World** - Vast wasteland exploration
• **Base Building** - Construction and fortification
...
---
**Premium external cheat with built-in spoofer for maximum Deadside protection and performance!**`)
            .addFields(
                {
                ...
                {
                    name: '`📞` PURCHASE',
                    value: 'Contact our staff to get your Lexy Deadside premium cheat.'
                }
            )
            .setColor('#FFD700')
            ...
            .setFooter({
                text: 'Lexy Deadside • External • Built-in Spoofer • Premium Quality',
