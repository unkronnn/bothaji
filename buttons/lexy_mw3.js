...
• **Games Supported:** Modern Warfare 3, DMZ, Warzone, Black Ops 6
...
**Premium external cheat for serious Call of Duty competitors!**`)
            .addFields(
                ...
                {
                    name: '`📞` PURCHASE',
                    value: 'Contact our staff to get your Lexy MW3 premium cheat.'
                }
            )
            .setColor('#9370DB')
            ...
            .setFooter({
                text: 'Lexy MW3 • External • Premium Quality • Multi-Game Bundle',
