...
module.exports = {
    customId: 'pussycat_dayz',
    async execute(interaction) {
        const embed = new EmbedBuilder()
            .setTitle('🐱 PussyCat : DayZ - Budget External Cheat')
            .setDescription(`
### 🧾**Pricing**
...
A premium product for the game DayZ from PussyCat group.
...
• **Resource Gathering** - Scavenging and exploration
• **Base Building** - Construction and defense
• **Vehicle System** - Transportation mechanics
...
---
**Budget-friendly external cheat for DayZ with essential features and maximum security!**`)
            .addFields(
                {
                ...
                {
                    name: '`📞` PURCHASE',
                    value: 'Contact our staff to get your PussyCat DayZ premium cheat.'
                }
            )
            .setColor('#FFB6C1')
            ...
            .setFooter({
                text: 'PussyCat DayZ • External • Budget-Friendly • Essential Features',
