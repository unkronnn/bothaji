...
module.exports = {
    ...
    async execute(interaction) {
        const embed = new EmbedBuilder()
            .setTitle('💪 Crooked Arm\'s : Black Ops 7 - Advanced External Cheat')
            .setDescription(`
### 🧾**Pricing**
...
• **Distances for Smooth/Jitter** - Distance-based behavior adjustment
...
• **Draw Distance** - Maximum visibility range
...
• Draw vehicles in multiplayer with distance display
• **Draw Active Explosives** - Field modifications and threats
• **Only Enemy Items** - Filter friendly equipment
...
✅ **Advanced Aimbot** - Human-like with multiple presets and distance-based control
...
### 🎮**Perfect For:**
• Advanced Black Ops 7 players seeking comprehensive features
...
• Black Ops 7 tactical enthusiasts

### ⚔️**Black Ops 7 Excellence:**
• **Next-Gen Combat** - Optimized for BO7 advanced warfare
• **Future-Ready Technology** - Prepared for upcoming BO7 updates
• **Advanced Mechanics** - Support for new BO7 gameplay features
• **Tactical Integration** - Seamless BO7 combat enhancement
...
**Advanced external cheat with comprehensive Black Ops 7 features!**`)
            ...
            .setFooter({
                text: 'Crooked Arm\'s Black Ops 7 • External • Advanced Features • BO7 Specialized',
