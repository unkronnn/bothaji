...
module.exports = {
    customId: 'unicore_wutheringwaves',
    async execute(interaction) {
        const embed = new EmbedBuilder()
            .setTitle('🌊 Unicore : Wuthering Waves - Internal Advanced RPG Features')
            .setDescription(`
### 🧾**Pricing**
...
A premium product for the game Wuthering Waves from Unicore group.
...
• **Game Mode:** Any
• **StreamProof:** No
• **Game Client:** Wuthering Waves Launcher & Epic Games
...
---
**Internal cheat with comprehensive combat, teleportation, and visual ESP for ultimate Wuthering Waves exploration and combat dominance!**`)
            .addFields(
                {
                ...
                {
                    name: '`📞` PURCHASE',
                    value: 'Contact our staff to get your Unicore Wuthering Waves premium cheat.'
                }
            )
            .setColor('#4169E1')
            .setThumbnail("https://media.discordapp.net/attachments/1412314599637651477/1434088772135424041/file.png.jpeg?ex=69070ebf&is=6905bd3f&hm=87262a13b8a787b6785849841506946668fc482be83748ec3e54c04133d32849&=&format=webp&width=700&height=700")
            .setFooter({
                text: 'Unicore Wuthering Waves • Internal • Advanced Combat & Teleport • Professional ESP',
